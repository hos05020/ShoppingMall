...
0.회원 가입 및 로그인   (세션 및 쿠키 이용)
---------------------------------------
회원 가입을 할 수 있고 로그인을 해야 상품을 등록 및 수정, 삭제 할 수 있습니다. 
...
2.상품 목록,등록,수정,삭제 (Spring Data JPA +QueryDSL 사용)
-----------------------------------------------------------------
...
1. 검색 기능이 추가되었습니다.('제목','내용','제목+내용'으로 검색할 수 있습니다.) => QueryDSL 사용
...
4.추후 변경 내용: 세션이 아닌 스프링 시큐리티(토큰)을 이용한 로그인 기능 구현
---------------------------------------
